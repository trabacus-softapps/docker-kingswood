...
#             res[case.id] = case.total
    ...
    _columns = {
              ...
              'name'             :  fields.many2one('res.partner', 'Paying Agents', required=True, ondelete='cascade', help="Supplier of this product"),
...
#                 for case in self.browse(cr,uid,prod_ids):
                ...
                product_price_id=vals.values()[0]
